...
export default class StatusPage extends Component {
    ...
    <div>
        <table>
            ...
            <tr>
            <td>{this.props.status[0]}</td>
            <td>Script1</td>
            </tr>

            <tr>
            <td>this.props.status2[0]}</td>
            <td>Script2</td>
            </tr>
        ...
        <div>
        <button onClick={this.props.callHealthCheck1}>Call Healthcheck 1</button>
        <button onClick = {this.props.callHealthCheck2}> Call Healthcheck 2 </button>
        </div>
    </div>
        )
    }
